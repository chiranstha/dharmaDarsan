...
class _MonthViewState extends ConsumerState<_MonthView>
  ...
  void _handleNextMonth() {
    if (!_isDisplayingLastMonth) {
      ...
      _dayPickerController.nextPage(
          duration: _kMonthScrollDuration, curve: Curves.elasticOut);
    }
  }
  ...
  getdata() async {
    final dw = await ref.read(eventProvider).getEventsByMonth(
        _currentDisplayedMonthDate.year.toString(),
        _currentDisplayedMonthDate.month.toString());
    ref.read(dateStateProvider.notifier).setdate(dw);
  }
